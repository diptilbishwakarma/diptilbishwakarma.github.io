...
function checkWin() {
    ...
    if (a1 === a2 && a2 === a3 && a1 === "X" || b1 === b2 && b2 === b3 && b1 === "X" || c1 === c2 && c2 === c3 && c1 === "X") {
        document.getElementById("ttc_winner").innerHTML="Result: Player 1 wins";
        return;
    }

    if (a1 === b2 && b2 === c3 && a1 === "X" || c1 === b2 && b2 === a3 && c1 === "X") {
        document.getElementById("ttc_winner").innerHTML="Result: Player 1 wins";
        return;
    }
    ...
    if ( a1 === a2 && a2 === a3 && a1 === "O" || b1 === b2 && b2 === b3 && b1 === "O" || c1 === c2 && c2 === c3 && c1 === "O") {
        document.getElementById("ttc_winner").innerHTML="Result: Player 2 wins";
        return;
    }

    if (a1 === b2 && b2 === c3 && a1 === "O" || c1 === b2 && b2 === a3 && c1 === "O") {
        document.getElementById("ttc_winner").innerHTML="Result: Player 2 wins";
        return;
    }
